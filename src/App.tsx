...
const themeVariables: Record<AccentTheme, CSSProperties> = {
  sakura: {
    ...
    '--soft-shadow': '0 26px 78px rgba(255, 94, 150, 0.13)',
  } as CSSProperties,
  peach: {
    '--page-bg': '#fff3f1',
    '--rose': '#ff967f',
    ...
    '--soft-shadow': '0 26px 76px rgba(235, 121, 92, 0.12)',
  } as CSSProperties,
  lavender: {
    '--page-bg': '#fbf4ff',
    '--rose': '#b892ff',
    ...
    '--rose-soft': '#f1e7ff',
    '--line-strong': 'rgba(255, 255, 255, 0.76)',
    '--soft-shadow': '0 26px 76px rgba(137, 95, 206, 0.12)',
  } as CSSProperties,
  mint: {
    '--page-bg': '#f3fbf8',
    '--rose': '#76b8a5',
    ...
    '--rose-soft': '#e3f5ef',
    '--line-strong': 'rgba(255, 255, 255, 0.76)',
    '--soft-shadow': '0 26px 76px rgba(67, 142, 119, 0.12)',
  } as CSSProperties,
}
